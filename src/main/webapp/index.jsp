        ...
        <div class="row">
          <div class="col-lg-10 mx-auto">
            <div class="detail-box">
              <h1>
                Discover Your Favorite And Food
              </h1>
              <a href="/itemlist"><button style="background-color: #007bff; padding:20px; color: white; border-radius: 25px; border-style: none;">MainMenu</button></a>
